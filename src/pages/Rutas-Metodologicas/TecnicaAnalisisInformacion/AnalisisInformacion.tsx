      ...
      <IonCard class="cardComponent">
        <IonCardHeader>
          ...
          <IonCardContent >
            ...
            <div id='buttoncenter'><IonButton  className='tbut' color="tertiary" onClick={buttonHandler} id="Triangulación">{element.btntri}</IonButton></div>
