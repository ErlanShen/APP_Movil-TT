        ...
        <IonCardHeader >
          ...
          <IonCardContent  id='tjustify'>{element.Descripcion}</IonCardContent>
           ...
           {element.Pregunta}
            ...
            <IonButton  color="tertiary" id="Explicativo" onClick={buttonHandler}>{element.BtnNi}</IonButton>   
      </IonCardContent>
      </IonCard>
    )}
  ...
  /* return (
    <IonPage >
      ...
      <IonContent>
        <IonCard>
        <IonCardHeader>
          <IonCardTitle id='buttoncenter'>Preexperimento </IonCardTitle>
        </IonCardHeader>
